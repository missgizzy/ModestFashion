...
namespace ModestFashion.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ModestFashionContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string imageName = "No-image-available.png";
        ...
        public async Task<IActionResult> Edit(int id, Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (product.ImageUpload != null)
                {
                    ...
                    if(!string.Equals(product.Image, "No-image-available.png"))
                    {
